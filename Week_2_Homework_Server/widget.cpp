...
void Widget::Time_Out_Slots()
{
    Step_Time_Number++;
    Sum_Time_Number++;
    if(!Game_Is_Over && Step_Time_Number == 30 && Step_Number%2==1) {QMessageBox::information(this,"超时","您当前已经超时，系统判定对方为赢家！");Game_Is_Over=true; return;}
    if(!Game_Is_Over && Step_Time_Number == 30 && Step_Number%2==0) {QMessageBox::information(this,"超时","对方当前已经超时，系统判定您为赢家！");Game_Is_Over=true; return;}
